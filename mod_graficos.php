...
$titulo="Totais Diarios Combustivel";
$legenda1="Litros Gastos";

//obter dados
$q_total_comb_diario="select day(data) as 'dia', month(data) as 'mes',sum(mov_combustivel.valor_movimento) as 'total' from mov_combustivel group by date(data) order by data desc limit 7";
...
for($i=$n_total_comb_diario-1;$i>=0;$i--){
	$datay1[$j]= mysql_result($r_total_comb_diario, $i,'total');
