            ...
            if($n_eventos_horas > 0) //se existirem eventos de horas do funcionario
            {
                for($j=0;$j<$n_eventos_horas;$j++)
                {
                    ...
                    if(mysql_result($r_eventos_horas,$j,'mov_viatura.id_acessorio') > 0)
                    {
                        ...
                        $dados_horas_funcionario = " com <b>".mysql_result($r_detalhes_acessorio,0,'desc_viatura')."</b> ".(mysql_result($r_eventos_horas,$j,'mov_viatura.horas_trab_acessorio')/60)."H".(mysql_result($r_eventos_horas,$j,'mov_viatura.horas_trab_acessorio')%60)."m";
                    }
